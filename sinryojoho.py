    ...
    if shohou_kaisi == True:
        ...
        if is_alidone != "":
            ...
            if shohou == "将来":
                ...
                if is_alidone != "":
                    shohou_irai = f"服薬が安定しましたところで、改めてご連絡させていただきます。その際には、アリドネパッチ等の抗認知症薬の処方につきまして、先生からご処方をご検討賜れますと誠にありがたく存じます。大変お忙しいところに、また誠に厚かましいお願いとなり恐縮ではございますが、どうかご高配のほど何卒よろしくお願い申し上げます。"
    if shohou == "初回依頼":
